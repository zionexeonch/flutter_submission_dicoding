...
var listOfProducts = [
  Product(
      id: '1',
      title: 'Modern Chair',
      subTitle: 'Cheap, Aesthetic, and Elegant for your living room',
      imageProducts:
      ...
      category: CategoryType.livingRoom,
      price: 'Rp 133.000,-',
      realPrice: 133000,
      storeName: 'Adi Jaya',
      city: 'Malang',
      description: 'Brand: Olympic' +
          '\nDimensi: (P) 51 x (L) 46 x (T) 82 cm' +
          '\nMaterial: plastik, kaki kayu' +
          '\nWarna: putih, hitam, merah, biru, hijau, kuning'),
  Product(
      id: '2',
      title: 'Lampu Plafon LED',
      subTitle: 'Lampu Plafon Led Modern 220v 18w Untuk Dapur / Ruang Tamu',
      imageProducts:
  ...
  Product(
      id: '3',
      title: 'Karpet Bulu',
      subTitle: 'Karpet Bulu Matras Bulu Rasfur Tebal 2,5 CM Polos Murah',
      imageProducts:
  ...
  Product(
      id: '4',
      title: 'Rak Susun Serbaguna',
      subTitle: 'Rak Serbaguna Rak Dinding Dekorasi Ruang Tamu 3 Tingkat',
      imageProducts:
  ...
  Product(
      ...
      subTitle: 'MEJA RUANG TAMU MINIMALIS KAKI KAYU RETRO MURAH',
      imageProducts:
  ...
  Product(
      ...
      category: CategoryType.bedRoom,
      price: 'Rp 4.399.000,-',
      realPrice: 4399000,
      storeName: 'sleep.center',
      city: 'Jakarta Barat',
      description: 'SUPERFIT  VULCAN\n\n Spesifikasi :\n• Couple Comfort Spring : pegas yg disusun secara vertikal untuk meredam guncangan' +
  ...
  Product(
      id: '7',
      title: 'Lemari Baju Portable',
      subTitle: 'SIMPLE CLOTH RACK / RAK BAJU LEMARI PORTABLE',
      imageProducts:
  ...
  Product(
      id: '8',
      title: 'Set Kamar Tidur Mewah',
      subTitle: 'Set Kamar Tidur Mewah Mebel Meubel Furniture Asli Jepara',
      imageProducts:
  ...
  Product(
      id: '9',
      title: 'Rak Kamar Tidur',
      subTitle: 'Rak Penyimpanan Serbaguna Dapat Dilepas Pasang 4 tingkat',
      imageProducts:
  ...
  Product(
      id: '10',
      title: 'ING Lampu Plafon Led Gaya Nordic',
      subTitle:
